...
var Nivel5 = {
  preload: function(){
    ...
    game.load.tilemap('map','assets/map/nivel5.csv');
  ...
  create: function(){
    ...
    portalwin = game.add.sprite(1560, 897, 'portalwin');
  ...
  game.physics.enable(sprite, Phaser.Physics.ARCADE);
   ...
   bolapuas = game.add.sprite(515, 593, 'bolapuas');
   ...
   tween = game.add.tween(bolapuas).to({ y: 260 }, 2000, Phaser.Easing.Linear.None, true, 0, 1000, true);

   bolapuas2 = game.add.sprite(830, 260, 'bolapuas');
   ...
   tween2 = game.add.tween(bolapuas2).to({ y: 593 }, 2000, Phaser.Easing.Linear.None, true, 0, 1000, true);
    ...
    baseboomerang = game.add.sprite(1444, 224, 'baseboomerang');
    baseboomerang.anchor.setTo(0.5, 0.5);
    baseboomerang.scale.setTo(0.3, 0.3);

    boomerang = game.add.sprite(1444, 224, 'boomerang');
    ...
    baseboomerang2 = game.add.sprite(1315, 415, 'baseboomerang');
    baseboomerang2.anchor.setTo(0.5, 0.5);
    baseboomerang2.scale.setTo(0.3, 0.3);

    boomerang2 = game.add.sprite(1315, 415, 'boomerang');
    ...
    baseboomerang3 = game.add.sprite(1444, 600, 'baseboomerang');
    baseboomerang3.anchor.setTo(0.5, 0.5);
    baseboomerang3.scale.setTo(0.3, 0.3);

    boomerang3 = game.add.sprite(1444, 600, 'boomerang');
    ...
    baseboomerang5 = game.add.sprite(227, 605, 'baseboomerang');
    baseboomerang5.anchor.setTo(0.5, 0.5);
    baseboomerang5.scale.setTo(0.3, 0.3);

    boomerang5 = game.add.sprite(227, 605, 'boomerang');
    ...
    baseboomerang6 = game.add.sprite(222, 802, 'baseboomerang');
    baseboomerang6.anchor.setTo(0.5, 0.5);
    baseboomerang6.scale.setTo(0.3, 0.3);

    boomerang6 = game.add.sprite(222, 802, 'boomerang');
