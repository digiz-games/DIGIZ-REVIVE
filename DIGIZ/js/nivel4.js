...
var Nivel4 = {
  preload: function(){
    ...
    game.load.tilemap('map','assets/map/nivel4.csv');
  ...
  create: function(){
    ...
    portalwin = game.add.sprite(1170, 510, 'portalwin');
  ...
  game.physics.enable(sprite, Phaser.Physics.ARCADE);
   ...
   bolapuas = game.add.sprite(225, 670, 'bolapuas');
   ...
   tween = game.add.tween(bolapuas).to({ y: 320 }, 2000, Phaser.Easing.Linear.None, true, 0, 1000, true);

   bolapuas2 = game.add.sprite(1110, 993, 'bolapuas');
   ...
   bolapuas3 = game.add.sprite(1245, 70, 'bolapuas');
   ...
   tween3 = game.add.tween(bolapuas3).to({ y: 400 }, 2000, Phaser.Easing.Linear.None, true, 0, 1000, true);
    ...
    baseboomerang = game.add.sprite(220, 480, 'baseboomerang');
    baseboomerang.anchor.setTo(0.5, 0.5);
    baseboomerang.scale.setTo(0.3, 0.3);

    boomerang = game.add.sprite(220, 480, 'boomerang');
    ...
    baseboomerang2 = game.add.sprite(223, 800, 'baseboomerang');
    baseboomerang2.anchor.setTo(0.5, 0.5);
    baseboomerang2.scale.setTo(0.3, 0.3);

    boomerang2 = game.add.sprite(223, 800, 'boomerang');
    ...
    baseboomerang3 = game.add.sprite(608, 660, 'baseboomerang');
    baseboomerang3.anchor.setTo(0.5, 0.5);
    baseboomerang3.scale.setTo(0.3, 0.3);

    boomerang3 = game.add.sprite(608, 660, 'boomerang');
    ...
    baseboomerang4 = game.add.sprite(795, 225, 'baseboomerang');
    baseboomerang4.anchor.setTo(0.5, 0.5);
    baseboomerang4.scale.setTo(0.3, 0.3);

    boomerang4 = game.add.sprite(795, 225, 'boomerang');
    ...
    baseboomerang5 = game.add.sprite(990, 609, 'baseboomerang');
    baseboomerang5.anchor.setTo(0.5, 0.5);
    baseboomerang5.scale.setTo(0.3, 0.3);

    boomerang5 = game.add.sprite(990, 609, 'boomerang');
